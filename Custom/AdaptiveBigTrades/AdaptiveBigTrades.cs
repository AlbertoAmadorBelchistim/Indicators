...
namespace ATAS.Indicators.Technical
{
    ...
    public class AdaptiveBigTrades : Indicator
    {
        ...
        public CrossColor BuyColor { get; set; } = System.Drawing.Color.FromArgb(150, 50, 205, 50).Convert();

        [Display(Name = "Sell Color", GroupName = "Colors", Order = 20)]
        public CrossColor SellColor { get; set; } = System.Drawing.Color.FromArgb(150, 220, 20, 60).Convert();
