...
public class ClusterStatisticPro : Indicator
{
	...
	private string GetHeader(DataType type)
	{
		return type switch
		{
			DataType.Ask => "Ask",
			DataType.Bid => "Bid",
			DataType.Delta => Res.Delta,
			DataType.DeltaVolume => Res.DeltaVolume,
			DataType.SessionDelta => Res.SessionDelta,
			DataType.SessionDeltaVolume => Res.SessionDeltaVolume,
			DataType.MaxDelta => Res.MaxDelta,
			DataType.MinDelta => Res.MinDelta,
			DataType.DeltaChange => Res.DeltaChange,
			DataType.Volume => Res.Volume,
			DataType.VolumeSecond => Res.VolumeSecond,
			DataType.SessionVolume => Res.SessionVolume,
			DataType.Trades => Res.Trades,
			DataType.Height => Res.Height,
			DataType.Time => Res.Time,
			DataType.Duration => Res.Duration,
			DataType.DeltaSecond => Res.DeltaSecond,
			DataType.BuyImbalance => Res.BuyImbShort,
			DataType.SellImbalance => Res.SellImbShort,
			DataType.NetImbalance => Res.NetImbShort,
			DataType.StackedBuyImbalance => Res.BuyStkShort,
			DataType.StackedSellImbalance => Res.SellStkShort,
			DataType.StackedNetImbalance => Res.NetStkShort,
			DataType.PeakVolPerSec => Res.PeakVolPerSec,
			DataType.PeakDeltaPerSec => Res.PeakDeltaPerSec,
			DataType.PeakDeltaPerVol => Res.PeakDeltaPerVol,
			DataType.None => string.Empty,
