...
> **Fase 2:** Clasificación Competitiva. Los indicadores se agrupan por función exacta para facilitar la comparación.
...
| **6.5/10** | 🔧 Mejorar | [Ask/Bid Volume Difference Bars](indicators/es/AskBidBars.md) | ¿Cuál fue el volumen agresivo neto (Delta) de esta vela? |
...
| Score | Estado | Indicador | Descripción / Notas |
| :---: | :--- | :--- | :--- |
| **7/10** | 🔧 Mejorar | [Bid Ask Volume Ratio](indicators/es/BidAskVR.md) | ¿Cuál es el desequilibrio normalizado del volumen agresivo? |
...
| **9/10** | ✅ Conservar | [CVD - Cumulative Volume Delta](indicators/es/CumulativeDelta.md) | ¿Cuál es el delta acumulado desde el inicio de la sesión? |
| **6/10** | Reemplazar por MultiMarketPower | [CVD pro / Market Power](indicators/es/MarketPower.md) | ¿Cuál es el delta acumulado (CVD) filtrado por tamaño de trade, y cómo se compara con su SMA? |
...
| **8/10** | Reparar | [Exhaustion](indicators/es/Exhaustion.md) | ¿Está el precio mostrando agotamiento en los últimos N ticks de la vela? |

## 💎 Open Interest
> *El compromiso. Dinero nuevo entrando vs cierre de posiciones.*

### ⚔️ Open Interest Analysis
...
| **3/10** | Reparar | [Herrick Payoff Index (HPI)](indicators/es/HerrickPayoff.md) | ¿Cuál es la fuerza del movimiento (Precio + Volumen + OI)? |
