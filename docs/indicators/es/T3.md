...
description: >-
  ¿Cuál es la tendencia suavizada eliminando el ruido con la fórmula T3 de Tillson?
# --- Campos de Triaje (Para ROADMAP.md) ---
gemini_summary: >-
  Implementación correcta de la media de Tillson usando 6 EMAs en cascada.
file_state: Estable
