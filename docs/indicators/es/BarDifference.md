...
description: ¿Cuántos ticks ha subido o bajado el precio (Cierre) en comparación con
  hace X velas?
gemini_summary: Inútil (3/10). Es un indicador de "Momentum" (ROC) ruidoso y redundante.
  El default (Period=1) es puro ruido.
...
**Nombre del archivo:**  [`BarDifference.cs`](https://github.com/AlbertoAmadorBelchistim/Indicators/blob/Develop/Technical/BarDifference.cs)  
**Nombre del indicador:** Bar Difference  
**Web oficial:**  [ATAS - Bar Difference](https://help.atas.net/support/solutions/articles/72000602523)  
**Compatibilidad**: ATAS versión estable y superiores.  
**Última revisión del código oficial:** 23/04/2025  
>**La Pregunta Clave:** ¿Cuántos ticks ha subido o bajado el precio (Cierre) en comparación con hace X velas?

![BarDifference](../../img/BarDifference.png)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI0NTY5MzQ4Ml19
-->