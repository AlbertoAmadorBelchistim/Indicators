...
| `ActiveVolume.cs` | [Active Volume](indicators/es/AD.md) | Order Flow | 8/10 | Conservar | Filtrando todas las pequeñas operaciones de 'ruido', ¿dónde está apareciendo realmente el volumen significativo y agresivo de compra y venta en la escala de precios? |
...
| `Alligator.cs` | [Alligator](indicators/es/Alligator.md) | Tendencia | 6/10 | Descartar | ¿Cuál es la fuerza _estable y suavizada_ de la tendencia, ignorando el ruido a corto plazo del propio ADX? |
...
| `AverageDelta.cs` | [Average Delta](indicators/es/AverageDelta.md) | Order Flow | 6.5/10 | Conservar (con reservas) | ¿Cuál es la volatilidad (ATR) del instrumento como un porcentaje de su precio actual? |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1NzI0NDA4OF19
-->