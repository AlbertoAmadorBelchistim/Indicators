namespace ATAS.Indicators.Technical
{
	...
	[DisplayName("VWMA")]
	[Display(ResourceType = typeof(FallbackResources), Description = nameof(FallbackResources.VWMADescription))]
	public class VWMA : Indicator
	{
		...
		[Display(ResourceType = typeof(FallbackResources),
			Name = nameof(FallbackResources.Smoothing),
			GroupName = nameof(FallbackResources.Settings),
			Description = nameof(FallbackResources.SmoothDescription),
			Order = 30)]
		[Range(1, 10000)]
