namespace ATAS.Indicators.Technical
{
	...
	public class Fractals : Indicator
	{
		...
		[Display(ResourceType = typeof(FallbackResources), Name = nameof(FallbackResources.Period), GroupName = nameof(FallbackResources.Settings), Description = nameof(FallbackResources.FractalPeriodDescription), Order = 10)]
